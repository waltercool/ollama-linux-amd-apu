...
Tested on AMD Ryzen 2000, 5000 and 7000 series APU. Needs >=6.10 Linux kernel.
Intended for use in container environments such as Podman and Docker, but can be used to custom builds.

## TLDR
Run ghcr.io/rjmalagon/ollama-linux-amd-apu:rocm-6.4.4-latest container image for AMD APUs.
