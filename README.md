...
## TLDR
Run ghcr.io/rjmalagon/ollama-linux-amd-apu:rocm-6.4.3-latest container image for AMD Ryzen 8000 series APU, or ghcr.io/rjmalagon/ollama-linux-amd-apu:rocm-6.3.4-latest container image for AMD Ryzen 5000 and 7000 series APU.
...
Change ROCM version to match your APU on the dockerfile, ROCM 6.3.4 for older APUs. ROCM 6.4.2 or ROCM 6.4.3 for newer APUs.
...
For recents AMD APUs, like Ryzen 8000 series APUs and newer AI series, there is a special image with ROCM 6.4.3 builtin on ghcr.io/rjmalagon/ollama-linux-amd-apu:rocm-6.4.3-latest, not recommended for older APUs (=<7000 series).
